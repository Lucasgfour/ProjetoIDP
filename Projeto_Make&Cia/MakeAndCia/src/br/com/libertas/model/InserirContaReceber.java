...
/**
 * Servlet implementation class InserirContaReceber
 */
@WebServlet("/InserirContaReceber")
public class InserirContaReceber extends HttpServlet implements Modelo{
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InserirContaReceber() {
        super();
