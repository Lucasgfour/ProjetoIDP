...
public class ContaReceberDao {
	 ...
	 *  @date 15-11-2020
	 *  @Descripition Responsavel por realizar a inserção de uma conta a Receber
	...
	/** @author Thulio Barbosa de Paula Martins
	 *  @date 15-11-2020
	 *  @Descripition Responsavel por realizar a exclusão de uma conta a Receber
	 *  @param int id
	...
	/** @author Thulio Barbosa de Paula Martins
	 *  @date 15-11-2020
	 *  @Descripition Responsavel por realizar a alteração de uma conta a Receber
	 *  @param ContaReceber cr
	 *  @return JsonObject resposta
	 */
